...
window.location.href = "../../Borrar?accion=borrarconferencia";
};

function enviaId3(id) {
  $.ajax({
    type:"POST", 
    url:"../../Imprimir", 
    data:{id:id}
