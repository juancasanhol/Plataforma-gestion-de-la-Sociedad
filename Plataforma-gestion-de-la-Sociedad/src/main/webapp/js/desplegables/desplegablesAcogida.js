    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            $.each(respuesta, function (i, option) {
                //console.log("buena");
                if(option.usuarios!==undefined){$("#DesplegablesUsuario").append('<option value="' + option.idUsuario + '">' + option.usuarios + '</option>');}
                ...
                if(option.ayudageneral!==undefined){$("#DesplegablesAyudaGeneral").append('<option value="' + option.idAyudageneral + '">' + option.ayudageneral + '</option>');}
                if(option.ayudarecibos!==undefined){$("#DesplegablesAyudaRecibos").append('<option value="' + option.idAyudarecibos + '">' + option.ayudarecibos + '</option>');}
                if(option.ayudasanitaria!==undefined){$("#DesplegablesAyudaSanitaria").append('<option value="' + option.idAyudasanitaria + '">' + option.ayudasanitaria + '</option>');}
                if(option.ayudaotra!==undefined){$("#DesplegablesAyudaOtra").append('<option value="' + option.idAyudaotra + '">' + option.ayudaotra + '</option>');}
