 ...
 */
@WebServlet(name = "VerFichaAcogida", urlPatterns = {"/VerFichaAcogida"})
public class VerFichaAcogida extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("./html/otros/VerFichaAcogida.html");
    }
